...
import { Mail, Lock, Eye, EyeOff, Wallet, ArrowRight, LogIn } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Sign in to access your finances</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <LogIn size={20} className="group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                  Sign In
